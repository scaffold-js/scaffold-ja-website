...
then
  ...
  deploy_ghpages () {
    # Deploying to GitHub Pages! (http://scaffold-js.github.io/)
    echo Deploying to GitHub Pages
    sed -i.tmp "s/\/\/ app.baseUrl = '\/scaffold-js/app.baseUrl = '\/scaffold-js.github.io/" app/scripts/app.js
  ...
  deploy_firebase () {
    # Deploying to Firebase! (https://scaffold-js.firebaseapp.com)
